...
public class ActionCounter {
    ...
    public final int oneDayMilliseconds = 1_000 * 60 * 60 * 24;
    ...
    public void add(long milliseconds) {
        ...
        if (first != null && System.currentTimeMillis() - first <= oneDayMilliseconds) {
            timeStamps = timeStamps.stream()
                    .filter(t -> System.currentTimeMillis() - t <= oneDayMilliseconds).collect(Collectors.toCollection(LinkedList::new));
        }
    }
